...
<body class=" bg-secondary">
    <div class="container">
        <div class="row justify-content-center mt-3 mb-2">
            <h1 class="text-center">Tambah Data Admin</h1>
            <div class="col-md-10 col-11 p-5 bg-light rounded-3">
                <form action="../../model/model_tambah_admin.php" method="post">
                    <div class="">
                        <label for="nonik" class="form-label">ID</label>
                        <input type="text" class="form-control" id="nonik" name="id" value="<?php echo $format; ?>" readonly>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="">
                        ...
                        <input type="text" class="form-control" id="inputSandi" name="pw" required>
                    </div>
